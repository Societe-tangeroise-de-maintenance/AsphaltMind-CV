...
class YOLOModel:
    ...
    def __init__(self):
        ...
        self.pothole_class_names = ['Drain Hole', 'Pothole', 'Sewer Cover']
...
##############################################################################################################
    ...
    async def detect_and_track_person_and_draw(self, image):
        results = self.pothole_model(image, persist=True, device=self.device)
...
##############################################################################################################
    async def detect_and_track_potholes_and_draw(self, image):
        ...
        results = self.pothole_model.track(image, persist=True, device=self.device, classes=0)
